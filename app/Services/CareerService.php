...
class CareerService
{
    ...
    public function processMatchResult(Prospect $prospect, bool $isWin, int $opponentLevel): array
    {
        ...
        // --- 6. Apply to User and Prospect Entities ---
        // Update user gold (not prospect gold) – unified gold system
        ...
        return [
            ...
            'new_level'   => $prospect->getLvl(),
            'new_gold'    => $user->getGold(),
            'new_xp'      => $prospect->getCurrentXp(),
            'xp_needed'   => $prospect->getXpRequiredForNextLevel(),
        ];
    }
}
