...
{
    // protected string $table = 'your_table_name'; // Optional: define table name if different from class name
    ...
    public function createProspectForUser(Request $request, $userId, $prospectData)
    {
        ...
        try {
            ...
            $stmtProspect->execute([
                ...
                ':height'              => $post['wrestlerHeight'],
                ':weight'              => $post['wrestlerWeight'],
                ':image'               => $post['wrestlerAvatar'],
                ':baseHp'              => 1000,
                ':strength'            => 50,
                ':technicalAbility'    => 50,
                ':brawlingAbility'     => 50,
    ...
    /**
     * Fetches all available nicknames from the database.
     */
