...
class Config
{
    ...
    public function __construct( $env )
    {
        ...
        $this->setting['template_url'] = $this->setting['site_url'] . self::DS . 'public' . self::DS . 'template' . self::DS . $this->setting['template_name'] . self::DS;
     ...
     * @return mixed
     */
    final public function setting( $setting )
    {
